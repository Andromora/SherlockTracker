...
function loadLists(){
    ...
    retrieveData(TAProducto, dbProductos, TAProductoRawData);
    retrieveData(TAMetodoPago, dbMetodosPago, TAMetodoPagoRawData);
    retrieveData(TAPaises, dbPaises, TAPaisesRawData);
...
function retrieveData(loadingList, dbLink, rawData){
    ...
    const getDataBase = async () => {
        try {
            ...
            if(rawDataBase.status === 200){
                ...
                loadingList.value = stringConcatenado;
